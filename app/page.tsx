    ...
    <main className="min-h-screen text-white pb-16 md:pb-0" style={{ background: 'var(--color-bg)' }}>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 px-8 md:px-14 max-w-xl w-full pt-24">
          ...
          <div className="hero-social flex flex-col gap-4">
            <div
          ...
          <div className="flex items-center gap-5">
            {[
              {
                href: 'https://www.instagram.com/anotherplanetwill/',
                label: 'Instagram',
              ...
              {
                href: 'https://www.facebook.com/AnotherPlanetOfCutsandStyles',
                label: 'Facebook',
              ...
              <a
                ...
                style={{ color: '#f97316', filter: 'drop-shadow(0 0 8px rgba(249,115,22,0.55))' }}
              >
